  ...
  buildAdFilterFromReq(req) {
    ...
    */
    ...
    if (typeof req.query.tags !== 'undefined' && req.query.tags !== '') {
      //Si req.query.tags tiene más de un elemento, los elementos se separan por comas
      //Si existe una coma, es que hay más de un elemento
      if (req.query.tags.indexOf(',') !== -1) {
        filters.tags = {};
        const tags = req.query.tags.split(',');
        //$all matchea si array del campo contiene todos los elementos del array "tags"
        filters.tags.$all = tags
      }
      //si no hay comas, solo hay un elemento...pasaremos al $in un array de un solo elemento
      else {
        filters.tags = {};
        //const tags[0] = req.query.tags
        //$in matchea si array del campo contiene algún elemento del array "tags"
